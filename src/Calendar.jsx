      ...
      <div>
        ...
        {!imgPrev ? (
          <button type="button" onClick={() => fileRef.current?.click()} style={{
            ...
            color:'#5a7a84', fontFamily:M, fontSize:'10px', padding:'14px', cursor:'pointer',
            ...
            onMouseLeave={e=>{e.currentTarget.style.borderColor='#263840';e.currentTarget.style.color='#5a7a84'}}
            ...
            <div key={i} style={{ background:'#080b0c', border:`1px solid ${RBDR[t.result]||'#1e2c32'}`, borderRadius:'10px', overflow:'hidden' }}>
              <div style={{ padding:'11px 12px', display:'flex', justifyContent:'space-between', alignItems:'center' }}>
                <div style={{ display:'flex', alignItems:'center', gap:'6px', flexWrap:'wrap' }}>
                  ...
                  <span style={{ fontFamily:M, fontSize:'9px', padding:'2px 7px', borderRadius:'4px', background:RBG[t.result]||'#111820', color:RC[t.result]||'#5a7a84', fontWeight:600 }}>{RL[t.result]||t.result}</span>
                ...
                <div style={{ display:'flex', alignItems:'center', gap:'8px' }}>
                  ...
                  <button onClick={() => setEditingIdx(isEd?null:ji)} style={{ background:isEd?'#263840':'none', border:`1px solid ${isEd?'#3a5460':'#1e2c32'}`, borderRadius:'5px', color:isEd?'#d0e8ec':'#5a7a84', fontFamily:M, fontSize:'9px', padding:'3px 8px', cursor:'pointer', transition:'all 0.15s' }}>✎</button>
                  ...
                  {week.map((cell, ci) => {
                    ...
                    return (
                      <div key={ci}
                        ...
                        {!mobile && aT.map((t,ti) => (
                          <div key={ti} style={{ fontFamily:M, fontSize:'8px', padding:'2px 5px', borderRadius:'3px', background:RBG[t.result]||'#111820', color:RC[t.result]||'#5a7a84', display:'inline-block', marginBottom:'2px', marginRight:'2px' }}>
